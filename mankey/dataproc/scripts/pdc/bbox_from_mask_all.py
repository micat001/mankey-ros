...
def main():
    ...
    for folder in os.listdir(log_root):
        ...
        pose_data_yaml_path = os.path.join(
            scene_processed_root, args.pose_yaml_filename
        )
        ...
        # Get the command
        pose_bbox_data_yaml_path = os.path.join(
            scene_processed_root, args.output_yaml_name
        )
        bbox_command = (
