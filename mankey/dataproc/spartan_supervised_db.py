...
class SpartanSupervisedKeypointDatabase(SupervisedImageKeypointDatabase):
    ...
    def _get_scene_from_config(
        self, config: SpartanSupvervisedKeypointDBConfig
    ) -> List[str]:
    ...
    def _build_scene_entry(
        self, scene_root: str, keypoint_yaml_name: str
    ) -> List[SupervisedKeypointDBEntry]:
        # Get the yaml file
        scene_processed_root = os.path.join(scene_root, "processed")
        keypoint_yaml_path = os.path.join(scene_processed_root, keypoint_yaml_name)
    ...
    def _get_image_entry(self, image_map, scene_root: str) -> SupervisedKeypointDBEntry:
        ...
        top_left.x, top_left.y = (
            image_map["bbox_top_left_xy"][0],
            image_map["bbox_top_left_xy"][1],
        )
        bottom_right.x, bottom_right.y = (
            image_map["bbox_bottom_right_xy"][0],
            image_map["bbox_bottom_right_xy"][1],
        )
