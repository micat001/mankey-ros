...
class BBoxRectificationTest(unittest.TestCase):
    def test_center_aligned(self):
        ...
        self.assertEqual(
            rectified_bottomright.x - rectified_topleft.x,
            rectified_bottomright.y - rectified_topleft.y,
        )
        self.assertEqual(
            rectified_bottomright.x + rectified_topleft.x, topleft.x + bottomright.x
        )
        self.assertEqual(
            rectified_bottomright.y + rectified_topleft.y, topleft.y + bottomright.y
        )
